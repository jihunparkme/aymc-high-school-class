...
### 2. 교사 관리
*   **교사 목록**: 전체 교사 목록을 조회하고 관리할 수 있습니다.
*   **교사 출결**: 교사들의 주간 출결, 기도제목, 특이사항을 기록하고 관리할 수 있습니다.

### 3. 관리자 모드
*   **출결 관리**: 학년별, 반별, 교사별 주간 출결 현황을 한눈에 파악할 수 있습니다.
*   **기도제목/특이사항 조회**: 전체 학생 및 교사의 기도제목과 특이사항을 모아서 보고 검색할 수 있습니다.
*   **반 관리**: 학년별 반을 추가, 수정, 삭제하고 담임 교사를 배정할 수 있습니다.
*   **교사 관리**: 교사를 추가, 수정, 삭제하고 담당 반을 확인할 수 있습니다.
*   **학생 관리**: 반별 학생을 추가, 수정, 삭제할 수 있으며 성별 정보를 포함합니다.
*   **데이터 관리**: 
    *   연간/월별 출결 현황을 그래프와 표로 시각화하여 제공합니다.
    *   현재 데이터를 JSON 파일로 백업하거나 복원할 수 있습니다.
...
│   ├── AttendanceManagement.jsx # 출결 현황 조회 (학생/교사)
│   ├── ClassManagement.jsx  # 반 관리
│   ├── ClassSelector.jsx    # 반 선택 화면
│   ├── DataManagement.jsx   # 데이터 통계 및 백업/복원
...
│   ├── TeacherList.jsx      # 교사 목록 화면
│   └── TeacherManagement.jsx # 교사 관리
